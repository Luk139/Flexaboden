...
const TechnischeDatenPdf = 'PDFs/HohlraumbodenMonoTeDaten.pdf';

const TechnischeDaten = () => {
  return (
    <div className="">
      <h1>Technische Daten</h1>
       <a href={TechnischeDatenPdf} download="Technische_Daten_Hohlraumboden_Mono.pdf" className="download-button">
            PDF herunterladen
          </a>
           <iframe 
